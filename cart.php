            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $row['quantity']; ?><a class="btn btn-default" style="margin-left: 30px" href="updateQuantity.php?type=more&id=&lt;?php echo $product_details['id']; ?&gt;">+</a> <a class="btn btn-default" href="updateQuantity.php?type=less&id=&lt;?php echo $product_details['id']; ?&gt;">-</a></td>
