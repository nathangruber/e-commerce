        ...
        <div class="row">
            <div class="col-xs-12 col-md-4 col-md-offset-4">
                ...
                <div class="starter-template">
                    <p class="lead">Enter Username and Password<br></p>
                </div>
                    ...
                    <form class="form-horizontal" action="includes/login.php" method="post">
                      ...
                      <div class="form-group">
                      <button type="submit" class="btn btn-stripe-1">Login</button>
                      </div>
                    </form>
                <div>
                    <center><p>No Account? Register below</p></center>
                    <center><a href="register.php" class="btn btn-stripe-1">Register</a></center>
                    <br>
                </div>
            </div>
        </div>
